...
export default function PembelianStats({ stats }: Props) {
  ...
  return (
    <div className="grid gap-3 md:gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-sm font-medium">Total Item Dibeli</CardTitle>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{formatCurrency(stats.total_hutang)}</div>
        </CardContent>
      </Card>
    </div>
  );
